...
implementors["bytecode"] = [{"text":"impl&lt;T:&nbsp;FootprintDomain&gt; Deref for AccessPathTrie&lt;T&gt;","synthetic":false,"types":[]},{"text":"impl&lt;E:&nbsp;Clone + Ord + Sized&gt; Deref for SetDomain&lt;E&gt;","synthetic":false,"types":[]},{"text":"impl&lt;K:&nbsp;Clone + Sized + Eq + Ord, V:&nbsp;AbstractDomain&gt; Deref for MapDomain&lt;K, V&gt;","synthetic":false,"types":[]}];
implementors["consensus_types"] = [{"text":"impl Deref for MaybeSignedVoteProposal","synthetic":false,"types":[]}];
implementors["diem_crypto"] = [{"text":"impl Deref for HashValue","synthetic":false,"types":[]}];
...
implementors["move_core_types"] = [{"text":"impl Deref for AccountAddress","synthetic":false,"types":[]},{"text":"impl Deref for Identifier","synthetic":false,"types":[]}];
